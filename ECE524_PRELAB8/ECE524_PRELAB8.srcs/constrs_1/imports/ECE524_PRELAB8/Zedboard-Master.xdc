...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {oclk}];  # "JA1"
...
set_property PACKAGE_PIN R16 [get_ports {SW[1]}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {SW[2]}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {SW[0]}];  # "BTNR"
