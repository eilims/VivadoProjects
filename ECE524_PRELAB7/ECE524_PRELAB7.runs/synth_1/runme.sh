...
HD_PWD='D:/VivadoProjects/ECE524_PRELAB7/ECE524_PRELAB7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Serial_Implementation_FIR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Serial_Implementation_FIR.tcl
