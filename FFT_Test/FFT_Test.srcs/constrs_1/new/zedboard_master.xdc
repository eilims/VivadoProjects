...
set_property PACKAGE_PIN Y8  [get_ports {AC_GPIO0}];  # "AC-GPIO0" SDATA_O
set_property PACKAGE_PIN AA7 [get_ports {AC_GPIO1}];  # "AC-GPIO1" SDATA_I
set_property PACKAGE_PIN AA6 [get_ports {AC_GPIO2}];  # "AC-GPIO2" BCLK_O
set_property PACKAGE_PIN Y6  [get_ports {AC_GPIO3}];  # "AC-GPIO3" LRCLK_O
set_property PACKAGE_PIN AB2 [get_ports {AC_MCLK}];  # "AC-MCLK" MCLK_O
set_property PACKAGE_PIN AB4 [get_ports {AC_SCK}];  # "AC-SCK" iic_rtl_scl_io
set_property PACKAGE_PIN AB5 [get_ports {AC_SDA}];  # "AC-SDA" iic_rtl_sda_io

# ----------------------------------------------------------------------------
# Clock Source - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {clk}];  # "GCLK" GCLK

# ----------------------------------------------------------------------------
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN Y11  [get_ports {mic_ncs}];  # "JA1"
#set_property PACKAGE_PIN AA8  [get_ports {JA10}];  # "JA10"
#set_property PACKAGE_PIN AA11 [get_ports {JA2}];  # "JA2"
#set_property PACKAGE_PIN Y10  [get_ports {mic_sdata}];  # "JA3"
#set_property PACKAGE_PIN AA9  [get_ports {mic_sclk}];  # "JA4"
...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W12 [get_ports {LED[8]}];  # "JB1"
#set_property PACKAGE_PIN W11 [get_ports {LED[9]}];  # "JB2"
#set_property PACKAGE_PIN V10 [get_ports {LED[10]}];  # "JB3"
#set_property PACKAGE_PIN W8 [get_ports {LED[11]}];  # "JB4"
#set_property PACKAGE_PIN V12 [get_ports {LED[12]}];  # "JB7"
