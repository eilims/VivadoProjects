...
HD_PWD='D:/VivadoProjects/FFT_Test/FFT_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_module.tcl -notrace
